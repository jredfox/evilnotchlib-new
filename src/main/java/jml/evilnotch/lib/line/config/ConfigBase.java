...
import jml.evilnotch.lib.line.comment.Comment;
import jml.evilnotch.lib.line.comment.IComment;
...
public abstract class ConfigBase {
	...
	public void loadConfig()
	{
		try
		{
			if(this.file.exists())
			{
				...
				List<String> list = JavaUtil.getFileLines(this.file);
				parseLines(list);
	...
	protected void saveConfig(List<String> list)
	{
		try
		{
			JavaUtil.saveFileLines(list, this.file);
		}
		catch(Exception e)
		{
			e.printStackTrace();
